    ...
    <div className="mx-4 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-auto">
      ...
      <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
        ...
        <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
          ...
          <div className="mb-10">
            <p className="py-2 text-xl font-semibold">Others change</p>
           
            <p className="mt-2">
              Make sure you have taken a backup of your account in case you ever need to get access to your data. We will
              completely wipe your data. There is no way to access your account after this action.
            </p>
            <button className="ml-auto text-sm font-semibold text-green-600 underline decoration-2">Continue to change here</button>
          </div>
          <hr className="mt-4 mb-8" />
