    ...
    <div className=" bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#0B253E] to-[#0B253E] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
        />
      </div>
          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md border-0 px-3.5 py-2 text-[#0d5a59] shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#0B253E] sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
