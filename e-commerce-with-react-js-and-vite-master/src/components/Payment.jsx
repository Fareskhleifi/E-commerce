  ...
  return (
    <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
      <div className="px-4 pt-8">
        <p className="text-xl font-medium">Commande verifer</p>
        <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
          <div className="flex flex-col rounded-lg bg-white sm:flex-row">
            <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src={slide1} alt="Skandika" />
            <div className="flex w-full flex-col px-4 py-4">
              <span className="font-semibold">Skandika  Tønsberg 5</span>
              <p className="text-lg font-bold">600 DT</p>
            </div>
          </div>
      
        </div>

        <p className="mt-8 text-lg font-medium">Payement Methodes</p>
      ...
      <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
        ...
        <p className="text-gray-400">Complete votre Order informations</p>
        <div>
          ...
          <div className="mt-6 border-t border-b py-2">
            <div className="flex items-center justify-between">
              ...
              <p className="font-semibold text-gray-900">600 DT</p>
            </div>
            <div className="flex items-center justify-between">
              <p className="text-sm font-medium text-gray-900">Achat</p>
              <p className="font-semibold text-gray-900">0 DT</p>
            </div>
          </div>
          <div className="mt-6 flex items-center justify-between">
            <p className="text-sm font-medium text-gray-900">Total</p>
            <p className="text-2xl font-semibold text-gray-900">600 DT</p>
          </div>
        </div>
        <Link to="/confirmer">
        <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white" >Confirmer Comande</button>
        </Link>
      </div>
    </div>
  );
